        ...
        if event.type == pygame.MOUSEBUTTONUP:
            if drawing and start_pos:
                if mode == "rect":
                    ...
                    drawSquare(canvas, color, start_pos, canvas_pos, radius)
                elif mode == "triangle":
                    drawRightTriangle(canvas, color, start_pos, canvas_pos, radius)
                elif mode == "etriangle":
                    drawEquilateralTriangle(canvas, color, start_pos, canvas_pos, radius)
                elif mode == "rhombus":
                    drawRhombus(canvas, color, start_pos, canvas_pos, radius)
